	...
	useEffect(() => {
		const getBusinessInfo = async () => {
			...
			if (business) {
				...
				setBusinessWebPage(business.business_web_page);
			...
			<div className="business-form-container">
				<div className="business-form-left-col">
					<form className="business-form" onSubmit={handleBusinessFormSubmit}>
						<div className="business-form-title">Update Business details.</div>
						{/* ---------------------name------------------------------------------------------------------------------ */}
						...
						{/* ------------------------------operation_hours----------------------------------------------------------------------- */}
						<label className="business-form-label">Hours</label>
...
export default EditBusinessFormPage;
